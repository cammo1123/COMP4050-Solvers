...
export declare class BoxTypeT implements flatbuffers.IGeneratedObject {
    ...
    active: boolean | null;
    maximumBoxes: number | null;
    constructor(reference?: string | Uint8Array | null, width?: number, length?: number, depth?: number, maxWeight?: number | null, boxWeight?: number | null, active?: boolean | null, maximumBoxes?: number | null);
