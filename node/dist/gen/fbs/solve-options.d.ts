...
export declare class SolveOptions implements flatbuffers.IUnpackableObject<SolveOptionsT> {
    ...
    static createSolveOptions(builder: flatbuffers.Builder, maxBoxes: number | null, allowRotation: boolean, timeoutMs: number | null, strategy: SolveStrategy | null, balanceWeight: boolean | null, allPermutations: boolean | null, singleBox: boolean | null, strictItemOrder: boolean | null, bestSubset: boolean | null): flatbuffers.Offset;
...
export declare class SolveOptionsT implements flatbuffers.IGeneratedObject {
    ...
    strictItemOrder: boolean | null;
    bestSubset: boolean | null;
    constructor(maxBoxes?: number | null, allowRotation?: boolean, timeoutMs?: number | null, strategy?: SolveStrategy | null, balanceWeight?: boolean | null, allPermutations?: boolean | null, singleBox?: boolean | null, strictItemOrder?: boolean | null, bestSubset?: boolean | null);
