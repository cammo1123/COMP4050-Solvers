...
export declare class SolveResponse implements flatbuffers.IUnpackableObject<SolveResponseT> {
    ...
    static addAlgorithmUs(builder: flatbuffers.Builder, algorithmUs: number): void;
    static addServerUs(builder: flatbuffers.Builder, serverUs: number): void;
...
export declare class SolveResponseT implements flatbuffers.IGeneratedObject {
    ...
    algorithmUs: number;
    serverUs: number;
    constructor(results?: (BoxResultT)[], failed?: (ItemTypeT)[], algorithmUs?: number, serverUs?: number);
